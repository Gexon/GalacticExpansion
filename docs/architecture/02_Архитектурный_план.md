...
**Ответственность:**
- Формирование AIM-команд
- Whitelist разрешенных команд
- Rate limiting (защита от спама)
- Очередь команд
- Логирование всех команд

**Технологии:** C#, Command Pattern

**Паттерны:** Command, Chain of Responsibility (для валидации)

**Интерфейсы:**
```csharp
// Оркестратор AIM-команд
...
- Эвристика для определения высоты поверхности
- Проверка spawn-protection зон

**Технологии:** C#, алгоритмы поиска
