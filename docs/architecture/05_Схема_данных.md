  ...
  "definitions": {
    "Colony": {
      ...
      "properties": {
        ...
        "HasPortal": { "type": "boolean", "description": "Наличие портала для телепортации" },
        "PortalPosition": { "$ref": "#/definitions/Vector3", "description": "Позиция портала (если есть)" },
        "PortalEntityId": { "type": "integer", "description": "Entity ID портала" },
