...
**Фаза:** Документация обновлена с учетом новых возможностей API v1.15 + добавлена система "Most Wanted", готов к началу разработки
...
gantt
    ...
    section Phase 4
    ThreatDir :p9, after p8, 6d
    HostilityTracker :p10, after p5, 7d
    ColonyEvolution :p11, after p8, 5d
```
